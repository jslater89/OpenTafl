...
public class AIMoveConsiderationCrashTest extends TaflTest {
    ...
    public void run() {
        ...
        FishyWorkspace w = new FishyWorkspace(this, game, state, 5);

        AlphaBetaGameTreeState root = new AlphaBetaGameTreeState(w, new GameState(state));

        AlphaBetaGameTreeState next = root.considerMove(Coord.get(4,0), Coord.get(4, 3));

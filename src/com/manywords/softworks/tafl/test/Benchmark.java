...
public class Benchmark extends TaflTest {
    ...
    public void run() {
        ...
        Log.println(Log.Level.CRITICAL, "Brandub 7: finished in " + ((end - start) / 1000d) + " sec, searching " + size + " nodes to depth " + desiredDepths.get(7));
        ...
        Log.println(Log.Level.CRITICAL, "Tablut 9: finished in " + ((end - start) / 1000d) + " sec, searching " + size + " nodes to depth " + desiredDepths.get(9));
        ...
        Log.println(Log.Level.CRITICAL, "Copenhagen 11: finished in " + ((end - start) / 1000d) + " sec, searching " + size + " nodes to depth " + desiredDepths.get(11));
        ...
        Log.println(Log.Level.CRITICAL, "Tablut 15: finished in " + ((end - start) / 1000d) + " sec, searching " + size + " nodes to depth " + desiredDepths.get(15));

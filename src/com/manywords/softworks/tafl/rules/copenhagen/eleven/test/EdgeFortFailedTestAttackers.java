...
public class EdgeFortFailedTestAttackers extends SeaBattle9Attackers {
    public EdgeFortFailedTestAttackers(Board board) {
        super(board);
    }

    public EdgeFortFailedTestAttackers(Board board, List<TaflmanHolder> taflmen) {
        super(board, taflmen);
    }
    ...
    public List<TaflmanHolder> generateTaflmen() {
        ...
        taflmen.add(new TaflmanImpl((byte) 1, Taflman.TYPE_TAFLMAN, Coord.get(2, 6), this, getBoard(), getBoard().getRules()));
    ...
    public Side deepCopy(Board board) {
        return new EdgeFortFailedTestAttackers(board, getStartingTaflmen());
    }
}

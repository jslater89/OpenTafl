...
public class Copenhagen11Defenders extends Side {
    public Copenhagen11Defenders(Board board) {
        super(board);
    }

    public Copenhagen11Defenders(Board board, List<TaflmanHolder> taflmen) {
        super(board, taflmen);
    }
    ...
    public Side deepCopy(Board board) {
        return new Copenhagen11Defenders(board, getStartingTaflmen());
    }

...
public class ShieldwallTestAttackers extends SeaBattle9Attackers {
    public ShieldwallTestAttackers(Board board) {
        super(board);
    }

    public ShieldwallTestAttackers(Board board, List<TaflmanHolder> taflmen) {
        super(board, taflmen);
    }
    ...
    public Side deepCopy(Board board) {
        return new ShieldwallTestAttackers(board, getStartingTaflmen());
    }
}

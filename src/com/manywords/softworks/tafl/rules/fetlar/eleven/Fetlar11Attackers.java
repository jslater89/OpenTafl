...
public class Fetlar11Attackers extends Side {
    public Fetlar11Attackers(Board board) {
        super(board);
    }

    public Fetlar11Attackers(Board board, List<TaflmanHolder> taflmen) {
        super(board, taflmen);
    }
    ...
    public Side deepCopy(Board board) {
        return new Fetlar11Attackers(board, getStartingTaflmen());
    }

...
public class SeaBattle9Attackers extends Side {
    public SeaBattle9Attackers(Board board) {
        super(board);
    }

    public SeaBattle9Attackers(Board board, List<TaflmanHolder> taflmen) {
        super(board, taflmen);
    }
    ...
    public Side deepCopy(Board board) {
        return new SeaBattle9Attackers(board, getStartingTaflmen());
    }
}

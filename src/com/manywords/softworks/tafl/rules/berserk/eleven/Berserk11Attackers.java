...
public class Berserk11Attackers extends Side {
    public Berserk11Attackers(Board board) {
        super(board);
    }

    public Berserk11Attackers(Board board, List<TaflmanHolder> taflmen) {
        super(board, taflmen);
    }
    ...
    public Side deepCopy(Board board) {
        return new Berserk11Attackers(board, getStartingTaflmen());
    }
    ...
    public List<TaflmanHolder> generateTaflmen() {
        ...
        taflmen.add(new Commander((byte) 5, Coord.get(1, 5), this, getBoard(), getBoard().getRules()));
        ...
        taflmen.add(new Commander((byte) 11, Coord.get(5, 1), this, getBoard(), getBoard().getRules()));
        ...
        taflmen.add(new Commander((byte) 17, Coord.get(9, 5), this, getBoard(), getBoard().getRules()));
        ...
        taflmen.add(new Commander((byte) 23, Coord.get(5, 9), this, getBoard(), getBoard().getRules()));

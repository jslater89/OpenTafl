...
public class Berserk11Defenders extends Side {
    public Berserk11Defenders(Board board) {
        super(board);
        setStartingTaflmen(generateTaflmen());
    }

    public Berserk11Defenders(Board board, List<TaflmanHolder> taflmen) {
        super(board, taflmen);
    }
    ...
    public List<TaflmanHolder> generateTaflmen() {
        ...
        taflmen.add(new Knight((byte) 32, Coord.get(4, 4), this, getBoard(), getBoard().getRules()));
